...
| 画面名 | 説明 |
|--------|------|
| ログイン | メール/パスワードまたはGoogleアカウントでログイン |
| ユーザー登録 | 新規アカウント作成 |

**ログイン画面**
![ログイン画面](docs/images/screens/login.png)

**ユーザー登録画面**
![ユーザー登録画面](docs/images/screens/register.png)

### メイン機能

| 画面名 | 説明 |
|--------|------|
| 施設検索（地図） | 現在地周辺の施設を地図上に表示 |
| 施設詳細 | 施設の詳細情報・レビュー・写真を表示 |

**施設検索（地図）**
![施設検索（地図）](docs/images/screens/search-map.png)

**施設詳細**
![施設詳細](docs/images/screens/location-detail.png)

### レビュー

| 画面名 | 説明 |
|--------|------|
| レビュー投稿 | 施設へのレビュー・写真を投稿 |

**レビュー投稿画面**
![レビュー投稿画面](docs/images/screens/review-post.png)
...
| マイページ | ユーザー情報の表示 |
| マイページ編集 | プロフィール情報の編集 |
| お気に入り一覧 | お気に入り登録した施設の一覧 |
| 投稿レビュー一覧 | 自分が投稿したレビューの一覧 |
| 設定 | 通知設定など |

**マイページ**
![マイページ](docs/images/screens/mypage.png)

**マイページ編集**
![マイページ編集](docs/images/screens/mypage_edit.png)

**お気に入り一覧**
![お気に入り一覧](docs/images/screens/favorites.png)

**投稿レビュー一覧**
![投稿レビュー一覧](docs/images/screens/my-reviews.png)

**設定**
![設定](docs/images/screens/setting.png)
