...
const NoLocationImage = () => {
    return (
        <div className="flex justify-center items-center rounded-full w-14 h-14 md:w-20 md:h-20 lg:h-24 lg:w-24 bg-black">
...
const LocationImage = ({ imagePath, alt }: { imagePath: string; alt: string }) => {
    ...
    return (
        <div className="w-14 h-14 md:w-20 md:h-20 lg:h-24 lg:w-24 relative rounded-full overflow-hidden border-2 border-blue-700 shadow-md shrink-0">
            {isLoading && (
